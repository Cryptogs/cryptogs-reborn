...
🔏 Edit your smart contract `CryptogsReborn.sol` in `packages/hardhat/contracts`
...
📚 Go through each topic from [solidity by example](https://solidity-by-example.org) editing `CryptogsReborn.sol` in **🏗 scaffold-eth**
