...
contract CryptogsReborn is Ownable, ERC721A, ReentrancyGuard {

    string public constant name = "Cryptogs Reborn";
    string public constant symbol = "POGSR";

    string public constant author = "Arthur Silveira";
